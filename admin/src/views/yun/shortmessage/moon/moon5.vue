        ...
        <div class="messagePromotionAdd mytable">
            ...
            <div class="product_center">
                <div class="product_center_item" v-for="(item, index) in productList" :key="index">
                    ...
                    <div class="div_pub">产品价格1：<el-input v-model="item.percentage" placeholder="请输入内容" @blur="blur(item.id)"></el-input></div>
                    <div class="div_pub">产品价格2：<el-input v-model="item.percentage1" placeholder="请输入内容" @blur="blur(item.id)"></el-input></div>
            ...
            <el-dialog
                ...
                <div>
                    ...
                    <div class="div_pub">产品价格1：<el-input v-model="fromb.percentage" placeholder="请输入内容"></el-input></div>
                    <div class="div_pub">产品价格2：<el-input v-model="fromb.percentage1" placeholder="请输入内容"></el-input></div>
                </div>
...
export default {
    ...
    methods: {
        ...
        goWebView(){
            const newUrl = window.location.protocol + '//' + document.domain + "/moon5/index.html"
            console.log(newUrl)
        ...
        getServiceData: function () {
            ...
            var query = '?page=1&page_size=50&type=8&type_a=108'
